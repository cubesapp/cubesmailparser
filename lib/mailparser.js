...
MailParser.prototype._finalizeContents = function() {
    ...
    if (this._currentNode.content) {
        ...
        if (!this._currentNode.attachment) {
            ...
            //**DK CHANGE: There is a case we found when using uuestream.decode, that this._currentNode.content is null
            //If null, then checksum.update(this._currentNode.content) crashes
            if(this._currentNode.content) {
